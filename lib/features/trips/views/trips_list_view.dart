...
import 'widgets/trips_table_card.dart';

/// Trips list. Provides its own cubit and loads on first build.
class TripsListView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: const _TripsListBody(),
    );
  }
}

class _TripsListBody extends StatelessWidget {
  const _TripsListBody();
          ...
          return Column(
            ...
            children: [
              ...
              TripsTableCard(
                ...
                onRowTap: (t) => context.go(AppRoutes.tripDetailFor(t.id)),
              ),
            ],
          );
        },
